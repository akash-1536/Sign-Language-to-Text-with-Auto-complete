...
num_samples=1896
batch_size=5
validaton_samples=631

training_set = train_datagen.flow_from_directory('dataset_massey_univ/data/preprocessed/train_tkdi',
                                                 target_size=(sz, sz),
...
test_set = train_datagen.flow_from_directory('dataset_massey_univ/data/preprocessed/test_tkdi',
                                            target_size=(sz , sz),
                                            batch_size=batch_size,
                                            color_mode='grayscale',
                                            class_mode='categorical')
...
with open("model/model-bw_tkdi.json", "w") as json_file:
    json_file.write(model_json)
print('Model Saved')
classifier.save_weights('model/model-bw_tkdi.h5')
print('Weights saved')
