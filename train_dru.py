...
num_samples=1401
batch_size=5
validaton_samples=465

training_set = train_datagen.flow_from_directory('dataset_massey_univ/data/preprocessed/train_dru',
                                                 target_size=(sz, sz),
...
test_set = train_datagen.flow_from_directory('dataset_massey_univ/data/preprocessed/test_dru',
                                            target_size=(sz , sz),
                                            batch_size=batch_size,
                                            color_mode='grayscale',
                                            class_mode='categorical')
...
print('Model Saved')
classifier.save_weights('model/model-bw_dru.h5')
print('Weights saved')
