...
num_samples=1450
batch_size=5
validaton_samples=482

training_set = train_datagen.flow_from_directory('dataset_massey_univ/data/preprocessed/train_smn',
                                                 target_size=(sz, sz),
...
test_set = train_datagen.flow_from_directory('dataset_massey_univ/data/preprocessed/test_smn',
                                            target_size=(sz , sz),
                                            batch_size=batch_size,
                                            color_mode='grayscale',
                                            class_mode='categorical')
...
with open("model/model-bw_smn.json", "w") as json_file:
    json_file.write(model_json)
print('Model Saved')
classifier.save_weights('model/model-bw_smn.h5')
print('Weights saved')
